...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        self.configurationRootController()
        self.configLanguge()
    }

    private func configurationRootController() {
    ...
    private func configLanguge() {
            ...
            if MOLHLanguage.currentAppleLanguage() == "" {
                MOLHLanguage.setDefaultLanguage(MOLHLanguage.currentLocaleIdentifier())
            }
